  ...
  try {
    ...
    const html = `
      <div style="font-family:sans-serif; max-width:520px; margin:0 auto;">
        <h2 style="color:#1e3a8a;">You're invited to a Kerph Premier team</h2>
        <p><strong>${escapeHtml(ownerLabel)}</strong> invited you to join their Kerph Premier plan as a teammate — a free seat is included, no card needed from you.</p>
    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        subject: `${ownerLabel} invited you to their Kerph Premier team`,
        html,
      }),
    });
